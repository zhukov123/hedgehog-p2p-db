...
- [ ] Add SQLite integration tests for remaining workflows.
  ...
  - [x] Accept invite actor creation, node creation, idempotent replay, wrong-token rejection, and expired-invite rejection are covered in `Hedgehog.Metadata.Sqlite.Tests`.
