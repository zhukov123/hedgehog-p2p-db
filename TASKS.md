...
- [ ] Add SQLite integration tests for remaining workflows.
  ...
  - [x] Revoke actor or node state changes, credential/invitation cleanup, audit, outbox, replay, and missing-target failure are covered in `Hedgehog.Metadata.Sqlite.Tests`.
