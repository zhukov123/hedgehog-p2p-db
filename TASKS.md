...
- [ ] Add invariant queries and repair-readiness checks.
  ...
  - [x] Gate recovery on applied migrations, SQLite integrity checks, outbox lag, expired active reservations, expired leases, under-replicated repair coverage, and audit registration.
...
- [ ] Add SQLite integration tests for remaining workflows.
  ...
  - [x] Recovery gate blocked and passing paths are covered in `Hedgehog.Metadata.Sqlite.Tests`.
