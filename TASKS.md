...
- [ ] Add invariant queries and repair-readiness checks.
  ...
  - [x] Evaluate SQLite recovery gates for migrations, metadata invariants, outbox, audit, reservations, repair deficit, and fresh capacity reports with fail-closed unknowns for cache and manifest readiness.
...
- [ ] Add SQLite integration tests for remaining workflows.
  ...
  - [x] Recovery gate evaluation, persisted metadata snapshots, audit evidence, and idempotent replay are covered in `Hedgehog.Metadata.Sqlite.Tests`.
