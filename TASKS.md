...
- [ ] Add SQLite integration tests for remaining workflows.
  ...
  - [x] Actor and node revocation, node key revocation, suspect replica marking, under-replication surfacing, lease fencing, idempotent replay, and missing-target rejection are covered in `Hedgehog.Metadata.Sqlite.Tests`.
