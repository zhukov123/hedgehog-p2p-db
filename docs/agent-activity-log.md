...
## 2026-07-14 - recovery gate workflow

- Branch: `agent/recovery-gate-2026-07-14`
- Task: implement the SQLite metadata `evaluate_recovery_gate` workflow so recovery checks can persist the authority degraded mode, audit the decision, and emit a recovery outbox notification when the mode changes.
- Tests:
