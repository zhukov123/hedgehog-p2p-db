...
- Branch: `agent/revoke-actor-node-2026-07-14b`
- Task: implement the SQLite metadata `revoke_actor_or_node` workflow for security revocation of actors and nodes.
- Tests:
