...
## 2026-07-22 - replica failure reconciliation

- Branch: `agent/replica-repair-reconcile-2026-07-22`
- Task: add the first repair detection slice so metadata-healthy replicas that are missing, corrupt, or unreadable are classified by the SQLite authority and produce pending repair jobs.
- Tests:
